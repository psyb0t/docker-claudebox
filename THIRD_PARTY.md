...
| [HashiCorp Terraform](https://www.terraform.io/) | inherited image package | `BUSL-1.1` (source-available, non-compete) | https://github.com/hashicorp/terraform | `aicodebox:v0.16.0-full` only | `latest-full` image only; not in `latest`. |
...
| [GitHub CLI (`gh`)](https://cli.github.com/) | inherited image package | `MIT` | https://github.com/cli/cli | `aicodebox:v0.16.0-full` only | `latest-full` image only; not in `latest`. |
| [`kubectl`](https://kubernetes.io/docs/reference/kubectl/) | inherited image package | `Apache-2.0` | https://github.com/kubernetes/kubectl | `aicodebox:v0.16.0-full` only | `latest-full` image only; not in `latest`. License text: [`LICENSES/Apache-2.0.txt`](LICENSES/Apache-2.0.txt). |
| [Helm](https://helm.sh/) | inherited image package | `Apache-2.0` | https://github.com/helm/helm | `aicodebox:v0.16.0-full` only | `latest-full` image only; not in `latest`. License text: [`LICENSES/Apache-2.0.txt`](LICENSES/Apache-2.0.txt). |
